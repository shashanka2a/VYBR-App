...
export function RegisterForm() {
  ...
  return (
    <div className="w-full max-w-md mx-auto bg-white p-8 rounded-lg shadow-sm">
      <div className="mb-6">
        <h1 className="text-2xl font-medium text-center text-gray-900">Create Account</h1>
      </div>
      
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="space-y-1">
          <Label htmlFor="email" className="text-sm font-medium text-gray-700">Email (.edu required)</Label>
          <Input
            id="email"
            type="email"
